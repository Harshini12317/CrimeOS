          ...
          <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-center">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-ink-600">
                Review complaints registered at this
                station and manage case assignment.
              </p>
            </div>
                ...
                <table className="w-full min-w-[1150px]">
                  ...
                  <thead>
                    <tr className="border-b border-gold-200 bg-maroon-900">
                      ...
                      <th className="px-5 py-4 text-left text-xs font-semibold uppercase tracking-[0.12em] text-gold-200">
                        Complaint
                      </th>
                      ...
                      <th className="px-5 py-4 text-right text-xs font-semibold uppercase tracking-[0.12em] text-gold-200">
                        Action
                      </th>
                    ...
                    {filteredComplaints.map(
                      (complaint) => (
                        <tr
                          ...
                          className="transition-colors hover:bg-maroon-50/40"
                        >
                          ...
                          <td className="px-5 py-4">
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              {isUnassigned(
                                ...
                                <Link
                                  href={`/assign-case?complaint_id=${encodeURIComponent(
