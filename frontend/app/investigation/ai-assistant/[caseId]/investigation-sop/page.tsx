      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6 lg:p-8 max-w-3xl">
          ...
          <div className="mt-3 mb-6">
            <h1 className="text-2xl font-semibold text-ink-900">Suggested Investigation Steps</h1>
            <p className="mt-1 text-sm text-ink-500">Case {caseId}</p>
            <p className="mt-2 text-sm text-ink-600">
              An AI-suggested path grounded in standard procedure, with relevant legal sections and case law.
            </p>
          </div>
